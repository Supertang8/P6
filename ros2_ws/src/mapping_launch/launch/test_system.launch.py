...
def generate_launch_description():
    mapping_launch_path = os.path.join(
        get_package_share_directory('mapping_launch'), 'launch', 'test.launch.py')
    ...
    static_lidar_to_lidar = Node(
        package='tf2_ros',
        executable='static_transform_publisher',
        arguments=['0', '0', '0', '-1.5708', '0', '0', 'rover/camera_init', 'drone/camera_init'],
        parameters=[{'use_sim_time': use_sim_time}],
    )
    ...
    return LaunchDescription([
        ...
        rviz_node,
        static_lidar_to_lidar,
        static_base_link_frame,
        static_map_frame,
        static_odom_frame,
        static_body_to_lidar,
        rover_mapping,
        drone_mapping,
        #merge_map_node,
        #map_expander,
